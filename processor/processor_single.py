...
def do_train(cfg,
             ...
             scheduler,
             loss_fn,
             num_query, local_rank, train_mode):
    ...
    for epoch in range(1, epochs + 1):
        ...
        for n_iter, (img1, img2, img3, vid, target_cam, target_view) in enumerate(train_loader):
            ...
            with amp.autocast(enabled=True):
                score, feat = model(img1, target, cam_label=target_cam, view_label=target_view )
                ...
                if dist.get_rank() == 0:
                    ...
                    for n_iter, (img1, img2, img3, vid, camid, camids, target_view, _) in enumerate(val_loader):
                        with torch.no_grad():
                            ...
                            target_view = target_view.to(device)
                            feat = model(img1, cam_label=camids, view_label=target_view)

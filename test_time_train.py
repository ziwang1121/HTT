...
from loss import make_loss, make_loss_ttt
...
if __name__ == '__main__':
    ...
    train_loader, val_loader_ttt, val_loader, num_query, num_classes, camera_num, view_num = make_dataloader(cfg)
    ...
    loss_func, center_criterion = make_loss_ttt(cfg, num_classes=num_classes)
